                            ...
                            <form>
                                ...
                                <div class="mb-4 form-floating">
                                	<input type="hidden" id="userPw2" name="userPw2" value="${SessionUserPW}">
                     				<input type="password" class="form-control" id="userPw" name="userPw" placeholder="비밀번호를 입력하세요" autocomplete="off" required >
                                ...
                                <div class="mb-4 form-floating">
                                    <input type="hidden" id="userPhone2" name="userPhone2" value="${SessionUserPhone}">
                     				<input type="tel" class="form-control" id="userPhone" name="userPhone" placeholder="전화번호를 입력하세요" value="${user.userPhone}" autocomplete="off" required >
                                ...
                                <br><br>
                                <input type="button" class="form-control-submit-button" onclick="location.href='myList.do'" value="내 게시글 조회" id="btn">
                                <span></span>
                                <input type="button" class="form-control-submit-button" onclick="location.href='myrentList.do'" value="대여내역" id="btn">
                                <span></span>
                                <br><br><br>
                                <input type="button" class="form-control-submit-button" onclick="location.href='main.do'" value="뒤로가기" id="btn3">
                            </form>
                            <!-- end of sign up form -->
                      </div>  <!-- end of text-box  -->
                    </div> <!-- end of col -->
