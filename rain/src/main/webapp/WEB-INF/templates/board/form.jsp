...
<br><br>
	<div class="container">
		...
		<table class="table">
			<tr>
				<th style="padding: 13px 0 0 15px; font-size: 20px;">제목</th>
				<td><input id="title" type="text" class="col-md-1 form-control input-sm" required></td>
			</tr>
			<tr>
				<th style="padding: 13px 0 0 15px; font-size: 19px;">내용</th>
		...
		<div class="pull-right">
			<input type="button" onclick="insert()" class="form-control-submit-button" id="btn" value="저장"/>
		</div>
	</div>
